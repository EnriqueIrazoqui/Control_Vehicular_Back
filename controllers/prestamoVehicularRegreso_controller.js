...
const post_PrestamoVehicularRegreso = async (req, res) => {
    ...
    await pool.getConnection().then( async (conn) => {
        const data = [idSalida, idSupervisor, idUsuario, idVehiculo, kilometraje, descripcionDanos, tapetes, llantasDeRefaccion, gatoHidraulico, extras, nivelDeCombustible, fechaHora, foto]
        try{
