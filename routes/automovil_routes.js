...
const { post_automovil, get_automovil, put_automovil, delete_automovil, buscar_automovil } = require('../controllers/automovil_controller.js');
...
router.get('/:idVehiculo',
    param('idVehiculo').exists().notEmpty().isNumeric(), buscar_automovil);
